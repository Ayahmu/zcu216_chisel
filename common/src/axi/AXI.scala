...
class AXIB_SLAVE(
    ...
    override val ar = Decoupled(new AXI_ADDR(ADDR_WIDTH, DATA_WIDTH, ID_WIDTH, USER_WIDTH, LEN_WIDTH))
    override val aw = Decoupled(new AXI_ADDR(ADDR_WIDTH, DATA_WIDTH, ID_WIDTH, USER_WIDTH, LEN_WIDTH))
}